...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Decentronium server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Decentronium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Decentronium features */
        {"decentronium", "masternode", &masternode, true, true, false},
        {"decentronium", "listmasternodes", &listmasternodes, true, true, false},
        {"decentronium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"decentronium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"decentronium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"decentronium", "masternodedebug", &masternodedebug, true, true, false},
        {"decentronium", "startmasternode", &startmasternode, true, true, false},
        {"decentronium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"decentronium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"decentronium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"decentronium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"decentronium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"decentronium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"decentronium", "mnbudget", &mnbudget, true, true, false},
        {"decentronium", "preparebudget", &preparebudget, true, true, false},
        {"decentronium", "submitbudget", &submitbudget, true, true, false},
        {"decentronium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"decentronium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"decentronium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"decentronium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"decentronium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"decentronium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"decentronium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"decentronium", "checkbudgets", &checkbudgets, true, true, false},
        {"decentronium", "mnsync", &mnsync, true, true, false},
        {"decentronium", "spork", &spork, true, true, false},
        {"decentronium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"decentronium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use decentroniumd, or the -server option to decentronium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> decentronium-cli " + methodname + " " + args + "\n";
}
