...
/** Utility functions used by the Decentronium Qt UI.
 */
namespace GUIUtil
{
...
// Render Decentronium addresses in monospace font
...
// Parse "decentronium:" URI into recipient object, return true on successful parsing
