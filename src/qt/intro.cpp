...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Decentronium"),
     ...
     * override -datadir in the decentronium.conf file in the default data directory
     * (to be consistent with decentroniumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
