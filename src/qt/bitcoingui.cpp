                                                                            ...
                                                                            nWeight(0)
{
    ...
    QString windowTitle = tr("Decentronium") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Decentronium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and decentronium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Decentronium"), this);
    aboutAction->setStatusTip(tr("Show information about Decentronium"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Decentronium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Decentronium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Decentronium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Decentronium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Decentronium help message to get a list with possible Decentronium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Decentronium client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Decentronium network", "", count));
}
...
{
    QString strTitle = tr("Decentronium"); // default title
