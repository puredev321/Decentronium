...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Decentronium decentronium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  decentronium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded decentronium transaction") + "\n" +
                               "  decentronium-tx [options] -create [commands]   " + _("Create hex-encoded decentronium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded decentronium transaction
