Contributing to Decentronium
============================

The Decentronium project operates an open contributor model where anyone is
...
The following applies to code changes to the Decentronium project, and is not to be
confused with overall Decentronium Network Protocol consensus changes.

Whether a pull request is merged into Decentronium rests with the project merge
...
Patches that change Decentronium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Decentronium consensus, it must have been
...
The project leader is the release manager for each Decentronium release.
