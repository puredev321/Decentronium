...
In order to support loading of multiple wallets in decentronium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is decentronium.cpp.
...
Changes to decentronium.cpp
----------------------
decentronium.cpp is the entry point into decentronium-qt, and as such, will require some minor modifications to provide hooks for
