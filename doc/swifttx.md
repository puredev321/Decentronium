...
This mechanism has been integrated into Bitcore-Node-Decentronium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Decentronium-Project/insight-api-decentronium#web-socket-api](https://github.com/Decentronium-Project/insight-api-decentronium#web-socket-api) 
* API: [https://github.com/Decentronium-Project/insight-api-decentronium#swifttx-transactions](https://github.com/Decentronium-Project/insight-api-decentronium#swifttx-transactions) 
...
By default, the Decentronium daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Decentronium daemon:
